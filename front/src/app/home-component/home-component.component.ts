...
export class HomeComponentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.cards.push(new Card('assets/3.png', {backgroundColor: '#8f3ee8', color: 'white'}, 'Faites votre choix MY GUY', 'Vous pourrez obtenir en direct les résultats du sondage afin de choisir au mieux la meilleure proposition.'));
